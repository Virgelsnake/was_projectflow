...
// ============================================
// CHART-SPECIFIC NODE APIs
// ============================================

app.get("/api/charts/:chartId/tree", (req, res) => {
  const { chartId } = req.params;
...
app.post("/api/charts/:chartId/update-node", (req, res) => {
  const { chartId } = req.params;
  const chart = charts[chartId];
...
app.post("/api/charts/:chartId/update-node-color", (req, res) => {
  const { chartId } = req.params;
  const chart = charts[chartId];
...
app.post("/api/charts/:chartId/add-node", (req, res) => {
  const { chartId } = req.params;
  const chart = charts[chartId];
...
app.delete("/api/charts/:chartId/delete-node", (req, res) => {
  const { chartId } = req.params;
  const chart = charts[chartId];
